...
A Python-based workflow for verifying ensemble forecasts using reliability diagrams and standard performance metrics.
...
Open and run `forecast_verification.ipynb` in Jupyter. The notebook walks through data loading, visualization, reliability assessment, and performance scoring for an ensemble streamflow forecast at an arbitrary river site.
